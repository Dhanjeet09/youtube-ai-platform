const HIGH_RPM_NICHES = {
  ...
  Sports: {
    name: "Sports",
    rpm: 5,
    keywords: ["world cup", "football highlights", "match analysis", "soccer skills", "football goals"],
    affiliatePartners: [
      { name: "Fanatiz", url: "https://www.fanatiz.com/", commission: "10%" },
      { name: "Nike", url: "https://nike.com/", commission: "5%" }
    ],
    shortRpm: 4,
    longRpm: 5
  },
  WorldCup: {
    name: "World Cup",
    rpm: 6,
    keywords: ["world cup 2026", "world cup highlights", "world cup analysis", "world cup predictions", "world cup moments"],
    affiliatePartners: [
      { name: "FIFA+", url: "https://www.fifa.com/fifaplus/", commission: "5%" },
      { name: "FanCode", url: "https://www.fancode.com/", commission: "10%" }
    ],
    shortRpm: 4,
    longRpm: 6
  }
